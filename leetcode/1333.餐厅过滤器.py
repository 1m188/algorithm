...
# [1333] 餐厅过滤器
#
# https://leetcode-cn.com/problems/filter-restaurants-by-vegan-friendly-price-and-distance/description/
#
# algorithms
# Medium (50.80%)
# Likes:    12
...
# Testcase Example:  '[[1,4,1,40,10],[2,8,0,50,5],[3,8,1,30,4],[4,10,0,10,3],
# [5,1,1,15,1]]\n1\n50\n10'
#
...
class Solution:
    def filterRestaurants(self, restaurants: List[List[int]],
        ...
        res = [i for i in restaurants if i[2]] if veganFriendly \
            else restaurants
