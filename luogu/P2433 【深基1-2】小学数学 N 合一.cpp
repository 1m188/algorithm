...
int main() {
    ...
    if (T == 1) {
        ...
        // 请自行完成问题 9 的代码
        cout << 22;
    } else if (T == 10) { // 牛吃草问题，求出时间增长多少，求出两种情况下的总工作量，求出初始有多少草，最后用目标工作量除以目标时间得到目标效率
        // 请自行完成问题 10 的代码
        cout << 9;
    } else if (T == 11) {
        // 请自行完成问题 11 的代码
        cout << 100.0 / 3;
    } else if (T == 12) { // 注意输出的形式
        // 请自行完成问题 12 的代码
        cout << int('M' - 'A' + 1) << '\n'
             << char('A' + 17);
    } else if (T == 13) {
        ...
        const double PI = 3.141593;
        int r1 = 4, r2 = 10;
        cout << int(pow(4.0 / 3 * PI * r1 * r1 * r1 + 4.0 / 3 * PI * r2 * r2 * r2, 1.0 / 3));
    } else if (T == 14) {
        // 请自行完成问题 14 的代码
        cout << round((120 - sqrt(120 * 120 - 4 * 3500)) / 2.0);
    }
    return 0;
}